...
export type AntibodyVariantDesignerBlockContract = BlockContract;
export type AntibodyVariantDesignerBlockOutputs  = BlockOutputs;
export type AntibodyVariantDesignerBlockData     = BlockData;
export const AntibodyVariantDesignerBlockPointer = BlockPointer;
